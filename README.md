...
- **Three new frozen stock models + six usernames (roster 32→38, daily 28→34).** C17 VWAP-reclaim ignition, C18 oracle trend-break + oracle reversal, C19 rumor ignition with oracle gate (hypotheses H37–H39, verdict withheld: on the partial 11-symbol daily pool C19 never fired ($0 season), C17 lost small, C18 lost ~$10–12k — first-fire and full-pool verdicts pending).
