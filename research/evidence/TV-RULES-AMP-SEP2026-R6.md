# Rules re-verification, sixth pass — The Leap by AMP Futures, September 2026
...
- **Result:** **zero rule changes since the 2026-09-16 capture and the five earlier 2026-09-17 passes.** Every constant in `data/contest_config.json` and every entry of the 94-instrument universe in `data/contest_universe.json` was re-read from this page and re-diffed. This is the sixth line-by-line verification.
...
Parsed mechanically by `scripts/verify.py::check_universe_transcription`, which re-reads this block and requires an exact match (symbol strings and numeric caps, same order, same count) with `data/contest_universe.json`. Any drift between this transcription and the committed data fails the build.
...
> - for CME:SR31! maximum amount for an open position is 25.0
> - for CBOT:ZC1! maximum amount for an open position is 10.0
> - for CBOT_MINI:XC1! maximum amount for an open position is 10.0
> - for CBOT_MINI:MZC1! maximum amount for an open position is 10.0
> - for CBOT:ZW1! maximum amount for an open position is 10.0
> - for CBOT_MINI:XW1! maximum amount for an open position is 10.0
> - for CBOT_MINI:MZW1! maximum amount for an open position is 10.0
> - for CBOT:ZS1! maximum amount for an open position is 10.0
> - for CBOT_MINI:XK1! maximum amount for an open position is 10.0
> - for CBOT_MINI:MZS1! maximum amount for an open position is 10.0
> - for CBOT:ZL1! maximum amount for an open position is 10.0
> - for CBOT_MINI:MZL1! maximum amount for an open position is 10.0
> - for CBOT:ZM1! maximum amount for an open position is 10.0
> - for CBOT_MINI:MZM1! maximum amount for an open position is 10.0
> - for CBOT:ZO1! maximum amount for an open position is 10.0
> - for CBOT:ZR1! maximum amount for an open position is 10.0
> - for CME:DC1! maximum amount for an open position is 25.0
> - for CME:LBR1! maximum amount for an open position is 25.0
> - for CME:GF1! maximum amount for an open position is 25.0
> - for CME:HE1! maximum amount for an open position is 25.0
> - for CME:LE1! maximum amount for an open position is 25.0

## Reconfirmations specific to this pass

All constants re-diffed unchanged: prize ladder, $50,000 cash ARV, wire/PayPal thresholds, 14-day claim deadline, tie rule, disqualification clause (§05/§09/§16), 60/min rate limit, auto-close at end, no-account-reset, ranking on closed P/L, hourly board refresh, competition window and registration window. Instrument count and order 94/94 identical to data/contest_universe.json including the trailing CBOT livestock block (DC1!/LBR1!/GF1!/HE1!/LE1!).
